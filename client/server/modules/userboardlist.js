...
function configUserBoardListModule(app) {
  app.get('/rest/issues-tracker/user/:idUser/board', function (req, res) {
    res.send(boards);
  });

}

module.exports.configUserBoardListModule = configUserBoardListModule;
